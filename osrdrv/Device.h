...
EXTERN_C PAGED EVT_WDF_DEVICE_PREPARE_HARDWARE EvtOSRDevicePrepareHardware;
EXTERN_C PAGED EVT_WDF_DEVICE_D0_ENTRY         EvtOSRD0Entry;
EXTERN_C PAGED EVT_WDF_DEVICE_D0_EXIT          EvtOSRD0Exit;